close all
 clear all
  ...
  gamma = 1.5; %controller gain parameter; Required value is somewhere around 0.04
 % Higher values of gamma lead to faster parametric convergence in general 
  
  %ref model
  am = 1000; %reference model am
  bm = 1000; %reference model bm
